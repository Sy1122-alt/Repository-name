...
SUBJECT_CHAPTER_RULES["高数"] = [
    ...
    (["极限", "间断", "无穷小", "无穷大", "等价", "奇函数", "\\begin{cases}", "f[f", "f\\left", "f(x-", "f(x+", "f(2x", "f(3x", "f(a", "f(\\ln", "函数值", "复合函数"], "01-函数与极限"),
    (["\\lim", "\\to"], "01-函数与极限"),
...
TOPIC_CONTENT_RULES = {
    "高数": [
        (["微分方程", "通解", "可分离变量", "一阶线性", "特征方程"], "常微分方程"),
        (["极值", "拐点", "凹凸", "单调", "渐近线", "最值", "最大", "最小", "中值", "罗尔", "拉格朗日"], "导数应用"),
        (["导数", "微分", "切线", "法线", "求导", "参数方程", "f'", "y'=", "dy=", "\\begin{cases}"], "一元函数微分学"),
        ([r"\lim", "极限", "间断", "无穷小", "无穷大", "等价", "数列", "收敛子列", "定义域"], "极限与连续"),
        ([r"\int", "不定积分", "原函数", "定积分", "变上限", "旋转体", "广义积分"], "一元函数积分学"),
        ([r"\iint", "二重积分", "偏导", "多元", "驻点", "全微分", r"\partial", "空间", "平面方程", "点到平面", "对称点"], "多元函数与二重积分"),
