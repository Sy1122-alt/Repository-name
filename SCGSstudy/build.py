...
(function(){
  ...
  function show(){
    ...
    box.innerHTML=
      '<div class="card">'
      +'<div class="meta">'+meta+(String(it.id||"").indexOf("L-")===0?'<button id="btnDel" style="margin-left:auto;background:#EA6668;color:#fff;border:none;border-radius:6px;padding:2px 10px;font-size:12px;cursor:pointer;">删除此题</button>':'')+'</div>'
