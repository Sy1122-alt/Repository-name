...
SUBJECT_CHAPTER_RULES["高数"] = [
    ...
    (["空间", "平面方程", "点到平面", "距离", "对称点", "yOz", "xOy", "xOz", "方向向量", "法向量", "梯度"], "07-多元函数微积分"),
...
TOPIC_CONTENT_RULES = {
    "高数": [
        ...
        ([r"\iint", "二重积分", "偏导", "多元", "全微分", "f(x,y", r"\partial", "空间", "平面方程", "点到平面", "对称点", "梯度"], "多元函数与二重积分"),
        ([r"\int_", "定积分", "变上限", "旋转体", "围成", "广义积分", "反常积分"], "定积分及其应用"),
        (["极值", "拐点", "凹凸", "单调", "渐近线", "最值", "最大", "最小", "中值", "罗尔", "拉格朗日"], "导数应用"),
        (["导数", "微分", "切线", "法线", "求导", "参数方程", "f'", "y'=", "dy="], "一元函数微分学"),
